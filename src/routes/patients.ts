...
router.get('/by-medico/:medicoId', (req, res) => patientController.getPatientsByMedico(req, res));
router.get('/by-medico/:medicoId/stats', (req, res) => patientController.getPatientsByMedicoForStats(req, res));
router.get('/test', (req, res) => patientController.testEndpoint(req, res));
router.get('/test-function/:medicoId', (req, res) => patientController.testFunction(req, res));
router.get('/test-historico/:medicoId', (req, res) => patientController.testHistorico(req, res));
