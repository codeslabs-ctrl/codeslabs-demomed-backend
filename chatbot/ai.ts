...
- Récipe PDF: **pie de página — clínicas (máx. 2)** como en el formulario. Si hay **varias** clínicas de atención, usa \`listar_clinicas\`, muestra **ID y nombre**, pregunta cuál(es) incluir (1 o 2), y llama \`crear_recipe_medico\` con **pies_clinica_ids**. Con **una sola** clínica no hace falta preguntar. Incluye paciente, nombres_medicamentos, texto_indicaciones. Si falla por consulta no completada, explica y ofrece \`open_section\`. Tras éxito: **PDF medicamentos** y **PDF indicaciones**.
